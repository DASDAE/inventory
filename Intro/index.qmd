...
As the experiment progresses — metadata revisions, more interrogators and settings, more researchers — the process becomes hard to manage and bug-prone.
...
In some industries, DFOS metadata has been integrated into broader domain standards, such as Energistics' [PRODML](https://energistics.org/prodml-developers-users). PRODML works well within an oil and gas production context, including DAS/DTS use cases, but it is built for upstream production — embedded in a broader wells/pipelines/facilities model and the Energistics XML/EPC/HDF5 stack — which is heavy for general DFOS deployments. It does have useful patterns:
