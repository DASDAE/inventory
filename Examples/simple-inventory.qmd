...
```python
trenched_label = inv.OpticalPathAnnotation(start_distance=50.0, end_distance=470.0, label="trenched")
loose_label = inv.OpticalPathAnnotation(start_distance=470.0, end_distance=770.0, label="loose")
```
