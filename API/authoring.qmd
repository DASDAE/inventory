...
::: {.callout-note}
The object half of this page — the YAML and JSON files, their names, and the envelope — is implemented. The track CSVs and the optical path epoch directories which hold them are not yet, and are refused by name rather than ignored.
:::
